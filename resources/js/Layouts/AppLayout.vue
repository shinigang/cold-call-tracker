                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    v-if="['admin', 'owner', 'consultant'].includes($page.props.authUserCurrentTeam.role.key)"
                                ...
                                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures && $page.props.auth.user.id == 1"
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Settings -->
                                            <DropdownLink
                                                :href="route('teams.show', $page.props.auth.user.current_team.uuid)">
                                                Team Settings
                                            </DropdownLink>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('calendar.index')" :active="route().current('calendar.index')"
                            v-if="['Administrator', 'Consultant', 'Owner'].includes($page.props.authUserCurrentTeam.role.name)">
                            Calendar
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <!-- Team Management -->
                            <template v-if="$page.props.jetstream.hasTeamFeatures && $page.props.auth.user.id == 1">
                                <div class="border-t border-gray-200 dark:border-gray-600" />
                                ...
                                <!-- Team Settings -->
                                <ResponsiveNavLink :href="route('teams.show', $page.props.auth.user.current_team.uuid)"
