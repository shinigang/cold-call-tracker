        ...
        <div
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-500 truncate dark:text-gray-400">
                    ...
                    <el-divider
                        v-if="company.website || company.email || (company.address_street && company.address_city && company.address_state) || company.linkedin"
                        direction="vertical" class="-top-[1px] !mx-1 group-[.is-active]/company:border-gray-400" />
