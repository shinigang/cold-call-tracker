...
<template>
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <footer class="bg-white rounded-lg shadow mt-8 dark:bg-gray-800">
                <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                    ...
                    <ul
                        ...
                        <li>
                            <a :href="route('terms.show')" target="_blank" class="hover:underline me-4 md:me-6">
                                Terms of Service
                            </a>
                        </li>
                        <li>
                            <a :href="route('policy.show')" target="_blank" class="hover:underline me-4 md:me-6">
                                Privacy Policy
                            </a>
                        </li>
                    </ul>
            ...
            <div class="flex justify-center mt-16 px-6 sm:items-center sm:justify-between hidden">
